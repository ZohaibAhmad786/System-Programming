...
namespace Assignment1ConnectionPool
{
    class Program
    {
        public static TcpListener listener = new TcpListener(9987);
        public static List<Socket> clients = new List<Socket>();
        public static StreamReader reader;
        public static StreamWriter writer;
        public static string con, terminate;
        public static int ConnectionPool = 2;
                ...
                new Thread(() => {
                    ...
                    while (true)
                    {
                            ...
                            if (clientMsg == "Exit" || clientMsg == "exit")
                            {
                                ...
                                terminate = ($"Client IP&PortNo. : {socket.RemoteEndPoint}, Connection Terminate Time : {DateTime.Now.ToLongTimeString()};");
