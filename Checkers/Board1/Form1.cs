...
namespace Board1
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Button A1 { get; private set; }
            ...
            try
            {
                for (int i = 0; i < 8; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        ...
                        {
                            buttons[i, j].GetButton.Image = Board1.Properties.Resources.red;
                        }

                        else if (buttons[i, j].getmark == 'b')
                        {
                            buttons[i, j].GetButton.Image = Board1.Properties.Resources.blue;
                        }
        ...
        private void CheckForWinner()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                for (int j = 0; j < 8; j++)
                {
                    if (buttons[i, j].GetButton.Image == Board1.Properties.Resources.blue)
                    {
                        if (turn == true)
                        {
                            disablebuttons();
                    ...
                    else if (buttons[i, j].GetButton.Image == Board1.Properties.Resources.red)
                    {
                        if (turn == false)
                        {
                            disablebuttons();
                ...
                for (int i = 0; i < 8; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        if (currentbtn.Image == buttons[i, j].GetButton.Image)
                        {
                            ...
                            {
                                if (buttons[i, j].GetButton.Image == Board1.Properties.Resources.red)
                                {
                                    selectedbutton = buttons[i, j];
                                }
                            }
